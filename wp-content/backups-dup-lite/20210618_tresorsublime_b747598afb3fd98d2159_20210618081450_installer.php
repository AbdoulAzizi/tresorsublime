...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210618_tresorsublime_b747598afb3fd98d2159_20210618081450_archive.zip';
	const ARCHIVE_SIZE		 = '51301269';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'b747598-18081450';
    const SECONDARY_PACKAGE_HASH = 'c9165ec-18081450';
	const VERSION			 = '1.4.1';
