        ...
        <div class="wp-travel-engine-archive-outer-wrap">
            ...
            if($termchildren) {
                ...
                <div class="parent-desc" itemprop="description"><?php echo isset( $term_description ) ?  wp_kses_post( $term_description ) : ''; ?></div>
                    ...
                    {
                        echo "<div class='btn-loadmore' data-query-vars='".json_encode( $wte_trip_tax_post_qry->query_vars )."' data-current-page='".esc_attr( $pageed )."' data-max-page='".esc_attr( $wte_trip_tax_post_qry->max_num_pages )."'><span>".__("Load More Trips","travel-agency")."</span></div>";
                    }
                    ?>
                </div>
                <?php
                foreach ($termchildren as $child) {
                    ...
                    <div class="category-main-wrap category-grid col-3 grid <?php echo esc_attr( $term_child->term_id ); ?>" data-id="<?php echo esc_attr( $my_query->max_num_pages ); ?>">
                        ...
                        {
                            echo "<div class='btn-loadmore' data-query-vars='".json_encode( $my_query->query_vars )."' data-current-page='".esc_attr( $pageed )."' data-max-page='".esc_attr( $my_query->max_num_pages )."'><span>".__("Load More Trips","travel-agency")."</span></div>";
                        }
                        ?>
                    </div>
                <?php
