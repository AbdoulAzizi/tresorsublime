        ...
        <div class="wp-travel-engine-archive-outer-wrap">
            <div class="details">
                            ...
                            <div class="wrap">
                                ...
                                <div class="category-main-wrap category-grid col-3 grid <?php echo esc_attr($t->term_id);?>" data-id="<?php echo esc_attr( $my_query->max_num_pages ); ?>">
                                    <?php
                                        ...
                                        {
                                            echo "<div class='load-destination' data-query-vars='".json_encode( $my_query->query_vars )."' data-current-page='".esc_attr( $pageed )."' data-max-page='".esc_attr( $my_query->max_num_pages )."'><span>".__("Load More Trips","travel-agency")."</span></div>";
                                        }
                ...
                if ($others_query->have_posts()) { ?>
                    ...
                    $other_trips = apply_filters('wp_travel_engine_other_trips_title', __('Other Trips','travel-agency') ); 
                    echo esc_html($other_trips);
                    ?></span></h2>
                    <div class="wrap">
                        <div class="child-desc">
                            <p>
                                <?php $other_trips_desc = apply_filters('wp_travel_engine_other_trips_desc',__('These are other trips.','travel-agency') ); 
                        ...
                        <div class="category-main-wrap category-grid col-3 grid other" data-id="<?php echo esc_attr( $others_query->max_num_pages ); ?>">
                            <?php
                                ...
                                {
                                    echo "<div class='load-destination' data-query-vars='".json_encode( $others_query->query_vars )."' data-current-page='".esc_attr( $pageed )."' data-max-page='".esc_attr( $others_query->max_num_pages )."'><span>".__("Load More Trips","travel-agency")."</span></div>";
                                }
                                ?>
                        </div>
                    </div>
