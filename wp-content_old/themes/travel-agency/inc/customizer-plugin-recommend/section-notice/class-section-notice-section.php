 ...
 * @access public
 */
class Travel_Agency_Customizer_Section_Notice extends WP_Customize_Section {
	...
	?>
		<# if ( !data.hide_notice ) { #>
			<li id="accordion-section-{{ data.id }}" class="travel-agency-notice accordion-section control-section control-section-{{ data.type }} cannot-expand">
