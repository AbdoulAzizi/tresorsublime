...
Innofit WordPress Theme, Copyright (C) 2019-2021, SpiceThemes
Innofit is distributed under the terms of the GNU GPL

== Changelog ==

@Version 1.3.1
* Added Excerpt & Full content setting.

@Version 1.3
* Fixed the admin bar issue in resposive view.
* Fixed WooCommerce style and some prefix issues.

@Version 1.2.9
* Removed Google Plus social icon.
* Fixed the "ST: Latest News" widget issue.

@Version 1.2.8
* Escaped the pingback_url().
* Fixed the social icon widget issue.

@Version 1.2.7
* Fixed prefix, escaping and translation issues.
* Fixed the user comment issue.

@Version 1.2.6
* Updated the bootstrap version to fix the menu issue in WP 5.6.
...
Jquery appear:
Copyright: (c) Michael Hixson, Alexander Brovikov
License: MIT license (http://www.opensource.org/licenses/mit-license.php)
Source: https://github.com/bas2k/jquery.appear/

SmoothScroll:
Copyright: (c) Balazs Galambosi, Patrick Brunner, Michael Herf
License: MIT license
Source: https://github.com/themicon/smoothscroll
...
Copyright: (c) 2016 Codeinwp cristian-ungureanu
License: MIT license
Source: https://github.com/Codeinwp/customizer-controls/tree/master/customizer-page-editor

Customizer Subscribe Info:
Copyright: (c) Mikesetzer
License: Under GNU General Public License
Source: https://github.com/mikesetzer/origintheme/tree/master/inc/customizer-subscribe-info
...
Copyright (C) 2019-2021, SpcieThemes and available as [GPLv2](https://www.gnu.org/licenses/gpl-2.0.html)
